        ...
        while True:
                ...
                try:
                        ...
                        #add items to cart
                                ...
                                cart.cartAdd(currUserID)

                        #display previous orders 
                        elif (selection == 3):
                                user.previousOrders(currUserID)
...
class User:
	...
	#login and validate username and password
                currUserID = self.loginValidation()

	#send user to main store page 
                mainPage(currUserID,self)
    ...
    def previousOrders(self,currUserID):
        ...
        while True:
                #try:
                        ...
                        #remove an item
                                ...
                                self.cartRemove(currUserID, shoppingCart)
                                break
...
#adds items to the cart
	...
	#display the current cart
        self.cartDisplay(currUserID, shoppingCart)


#removes items from the cart
    def cartRemove(self,currUserID, shoppingCart):
